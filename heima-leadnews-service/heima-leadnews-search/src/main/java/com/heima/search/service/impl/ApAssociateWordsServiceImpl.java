...
public class ApAssociateWordsServiceImpl extends ServiceImpl<ApAssociateWordsMapper, ApAssociateWords> implements ApAssociateWordsService {
    ...
    @Override
    public ResponseResult searchV1(UserSearchDto dto) {
        //1.检查参数
        ...
        IPage page = page(pageParam, new LambdaQueryWrapper<ApAssociateWords>().like(ApAssociateWords::getAssociateWords, dto.getSearchWords()));
