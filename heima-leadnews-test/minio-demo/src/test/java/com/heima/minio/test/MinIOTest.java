...
public class MinIOTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            fileInputStream =  new FileInputStream("/Volumes/NEWSMY/trash/css/index.css");;
            //1.创建minio链接客户端
            MinioClient minioClient =
                    MinioClient.builder().credentials("minio", "minio123").
                            endpoint("http://192.168.185.136:9000").build();
            //2.上传
    ...
    public void testUpdateImgFile() {
        try {
            FileInputStream fileInputStream = new FileInputStream("/Volumes/NEWSMY/trash/list.html");
